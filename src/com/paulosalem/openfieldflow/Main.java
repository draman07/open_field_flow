 ...
 *
 */
package com.paulosalem.openfieldflow;

import com.paulosalem.openfieldflow.gui.SimulationControlWindow;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SimulationControlWindow control = new SimulationControlWindow();
